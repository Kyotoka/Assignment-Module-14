...
const ServicesCard = () => {
    ...
    return (
        <div className='p-10 '>
            <h2 className='uppercase font-semibold text-blue-300'>Our All Services</h2>
            <h2 className='uppercase font-bold my-3 text-blue-300'>We provide Best Web design<br /> services</h2>
            <div className="grid grid-cols-2 gap-8 p-20">
                {cardData.map((data, index) => (
                    <div key={data.name} className={`bg-blue-200 p-6 rounded-lg shadow-lg ${index > 1 ? 'mt-8' : ''}`}>
